...
public class RunnerSave03 {
    public static void main(String[] args) {
        Student03 student1  = new Student03();
                student1.setName("Hakan Sukur");
                student1.setId(1001);
                student1.setGrade(99);

        Student03 student2  = new Student03();
        student2.setName("Georghe  Hagi");
        student2.setId(1002);
        student2.setGrade(90);

        Student03 student3  = new Student03();
        student3.setName("Jürgen Klinsmann");
        student3.setId(1003);
        student3.setGrade(89);

        Diary  diary1 =  new Diary();
        diary1.setId(101);
        diary1.setName("Hakan Sukur'un Günlügü");
        diary1.setStudent(student1);

        Diary diary2 = new Diary();
        diary2.setId(102);
        diary2.setName("Hagi'nin günlügü");
