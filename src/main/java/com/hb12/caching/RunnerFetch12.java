...
//        // 1)
//        System.out.println("Ilk get islmei 1 id li ögrenci icn : ");
//        Student12 student1 = session.get(Student12.class, 1L);
//
//        session.clear();// methodu ile cache icini sifirladik(temizledik)
//
//        System.out.println("Ikinci get islmei 1 id li ögrenci icn : ");
